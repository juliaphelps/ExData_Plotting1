...
## 'construct_plot3()', which is designed to automate the process of:
##
...
##   - creating overlaying linear plots of 'Sub_metering_1', 'Sub_metering_2', and 'Sub_metering_3'
##     variables by weekday, displayed as one plot and differentiated by colour,
##   - annotating the plot to include appropriate labels and a legend,
##   - and saving this plot into the working directory as 'plot3.png'.
##
## 'construct_plot3()' requires the use of the lubridate package, as detailed above.  If the function
...
##
## Note:  This script is designed to work in conjunction with plot1.R, plot2.R, and plot4.R by the same
...
## command 'construct_plot3()'.  The script will do the rest!
...
construct_plot3 <- function(){
    ...
    png(file="plot3.png", width=480, height=480, bg="transparent", type="cairo")
    ...
    message("Output is located in working directory: 'plot3.png'")
}